...
<main role="main" class="main-content">
        ...
        <div class="h5">Add Requirements </div>
        <div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="card shadow mb-4">
                    ...
                    <div class="card-body  ">
                    <form action="{{ route('admin.require.store') }}" method="post" enctype="multipart/form-data">
                          @csrf
                                <div class="form-row">
                          <div class="col-md-12 mb-3">
                            <label for="exampleInputEmail1"> location</label>
                            <input type="name" name="location" id="location" placeholder="Enter Location" class="form-control
                 @error('location') is-invalid @enderror" value="{{ old('location') }}">
                 @error('location')
                 ...
                 @enderror
                          ...
                          <div class="col-md-12 mb-3">
                            ...
                            <select name="area_sqrtFit" id="area_sqrtFit"  class="form-control">
                                <option value="">Select Area</option>

                                <option value="Area">Area</option>
                                <option value="SquareFit">SquareFit</option>
                ...
                class="form-control @error('user_name') is-invalid @enderror" value="{{ old('user_name') }}">
                 ...
                 class="form-control @error('contact_number') is-invalid @enderror" value="{{ old('contact_number') }}">
