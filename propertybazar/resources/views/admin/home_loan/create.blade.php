                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <form action="{{ route('admin.home_loan.store') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-row">
                                        <div class="col-md-12 mb-3">
                                            <label for="loan_description">Loan Description</label>
                                           <textarea name="loan_description" id="loan_description" 
                                           placeholder="Enter loan_description" class="form-control @error('loan_description') is-invalid @enderror">
                                           {{ old('loan_description') }}</textarea>
