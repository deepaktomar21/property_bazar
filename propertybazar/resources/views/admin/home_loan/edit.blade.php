                                ...
                                <form action="{{ route('admin.home_loan.update', $homeloan->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12 mb-3">
                                          ...
                                          <textarea name="loan_description" id="required_description"
                                          placeholder="Enter required_description"
                                          class="form-control @error('loan_description') is-invalid @enderror">{{ old('loan_description', $homeloan->loan_description) }}</textarea>
