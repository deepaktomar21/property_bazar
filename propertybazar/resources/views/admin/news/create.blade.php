                            ...
                            <form action="{{ route('admin.news.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea name="news_description" id="news_description" placeholder="Enter news description" class="form-control @error('news_description') is-invalid @enderror">{{ old('news_description') }}</textarea>
