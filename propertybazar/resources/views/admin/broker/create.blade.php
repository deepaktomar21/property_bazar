            ...
            <a href="{{ route('admin.broker.list') }}" class="btn btn-primary">Back</a>
              ...
              <div class="row">
                <div class="col-md-6">
                 ...
                 class="form-control @error('broker_name') is-invalid @enderror" value="{{ old('broker_name') }}">
                 @error('broker_name')
                 ...
                 class="form-control @error('deals_description') is-invalid @enderror" value="{{ old('deals_description') }}">
