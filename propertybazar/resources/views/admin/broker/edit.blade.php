            ...
            <a href="{{ route('admin.broker.list') }}" class="btn btn-primary">Back</a>
              ...
              <div class="row">
                <div class="col-md-6">
                 ...
                 class="form-control @error('broker_name') is-invalid @enderror" value="{{ old('broker_name', $broker->broker_name) }}">
                 @error('broker_name')
                 ...
                 class="form-control @error('membership_id') is-invalid @enderror" value="{{ old('membership_id', $broker->membership_id) }}">
                 @error('membership_id')
                 <p class="invalid-feedback">{{ $message }}</p>
                 ...
                 @error('location') is-invalid @enderror" value="{{ old('location', $broker->location) }}">
                 @error('location')
                 <p class="invalid-feedback">{{ $message }}</p>
                 ...
                 class="form-control @error('contact_number') is-invalid @enderror" value="{{ old('contact_number', $broker->contact_number) }}">
                 ...
                 class="form-control @error('deals_description') is-invalid @enderror" value="{{ old('deals_description', $broker->deals_description    ) }}">
