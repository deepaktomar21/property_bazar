                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <form method="GET" action="{{ route('admin.userregister.list') }}" class="form-inline d-flex justify-content-between">
                                                    ...
                                                    <div>
                                                        ...
                                                        <a href="{{ route('admin.userregister.list') }}" class="btn btn-secondary btn-sm mb-2 ml-2">Refresh</a>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
