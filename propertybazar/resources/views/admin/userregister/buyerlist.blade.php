                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="heading1 margin_0">
                                                <h2>Register Buyer Table</h2>
                                            </div>
                                            <div>
                                                <!-- Search form aligned to the right -->
                                                <form method="GET" action="{{ route('admin.userregister.buyerlist') }}" class="form-inline d-flex justify-content-between">
                                                    ...
                                                    <div>
                                                        ...
                                                        <a href="{{ route('admin.userregister.buyerlist') }}" class="btn btn-secondary btn-sm mb-2 ml-2">Refresh</a>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
