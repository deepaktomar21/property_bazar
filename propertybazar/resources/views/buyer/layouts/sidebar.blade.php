<nav id="sidebar">
    ...
    <div class="sidebar_blog_2">
        <ul class="list-unstyled components">
            <li class="active">
                <a href="{{ route('buyer.dashboard') }}"><i class="fa fa-dashboard yellow_color"></i>
                    <span>Dashboard</span></a>
            </li>

            <li><a href="{{ route('buyer.management') }}"><i class="fa fa-gift red_color" aria-hidden="true"></i>
                    <span>Buyer Management
                    </span></a></li>
            <li><a href="{{ route('buyer.offers') }}"><i class="fa fa-asterisk green_color" aria-hidden="true"></i>
                    <span>Offers/Schemes</span></a></li>
            <li><a href="{{ route('buyer.requirements') }}"><i class="fa fa-search yellow_color" aria-hidden="true"></i>
                    <span>
            ...
            <li><a href="{{ route('buyer.logout') }}"><i class="fa fa-sign-out" aria-hidden="true"></i>
