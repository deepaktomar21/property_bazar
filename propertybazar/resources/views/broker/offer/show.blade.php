                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" name="offers" id="offers"
                                                    placeholder="Enter offers"
                                                    class="form-control @error('offers') is-invalid @enderror"
                                                    value="{{ old('offers', $offer->offers) }}" disabled>
                                                @error('offers')
                                                    <p class="invalid-feedback">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" name="contact_number" id="contact_number"
                                                    ...
                                                    value="{{ old('contact_number', $offer->contact_number) }}" disabled>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div>
                                                    <img src="{{ asset('https://textcode.co.in/propertybazar/public/uploads/' . $offer->images) }}"
