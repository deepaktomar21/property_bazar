<nav id="sidebar">
    ...
    <div class="sidebar_blog_2">
        <ul class="list-unstyled components">
            <li class="active">
                <a href="{{ route('broker.dashboard') }}"><i class="fa fa-dashboard yellow_color"></i>
                    <span>Dashboard</span></a>
            </li>

            <li><a href="{{ route('broker.management') }}"><i class="fa fa-gift red_color" aria-hidden="true"></i>
                    <span>Broker Management
                    </span></a></li>
            <li><a href="{{ route('broker.offers') }}"><i class="fa fa-asterisk green_color" aria-hidden="true"></i>
            ...
            <li><a href="{{ route('broker.logout') }}"><i class="fa fa-sign-out" aria-hidden="true"></i>
