                                        ...
                                        <div class="col-12">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="heading1 margin_0">
                                                    <h2>Seller Management Table</h2>
                                                </div>
                                                <div>

                                                    <form action="{{ route('seller.management') }}" method="GET"
                                                        class="form-inline">
                                                        ...
                                                        @if (request()->has('search'))
                                                            <a href="{{ route('seller.management') }}"
                                    ...
                                    <div class="table-responsive">
                                        <table id="example"
                                            ...
                                            <tbody>
                                                        ...
                                                        <tr id="select_ids{{ $user->id }}">
                                                            ...
                                                            <td class="text-center">
                                                                <div class="d-flex justify-content-center">
                                                                    <a href="{{ route('seller.management.show', $user->id) }}"
                                                ...
                                                @else
                                                    <tr>
                                                        <td colspan="8" class="text-center">No seller found.</td>
